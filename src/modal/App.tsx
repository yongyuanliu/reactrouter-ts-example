...
import { Link, Outlet, useLocation, Routes, Route, useParams, useNavigate } from "react-router-dom";
        ...
        <div>
            ...
            <Routes location={state?.backgroundLocation || location}>
                <Route path="/" element={<Layout />}>
                    ...
                    <Route path="/img/:id" element={<ImageView />}></Route>
...

            {
                state?.backgroundLocation && (
                    <Routes>
                        <Route path="/img/:id" element={<Modal />}></Route>
                    </Routes>
                )
            }
        </div>
...
function ImageView() {
    ...
    return (
        <div>
            <h1>{image.title}</h1>
            <img width={400} height={400} src={image.src} alt=""></img>
        </div>
    );
}
